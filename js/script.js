...
function checkNum() {
  ...
  // var telRegEx = /[0-9]{10}/;
  //
  // if (documesnt.getElementById("telephone").value.search(telRegEx) == -1) {
  //   document.getElementById("pasnum").innerHTML = "Entrer une adresse mail valide !";
  //   document.getElementById("telephone").style.borderBottomColor = "#880000";
  // } else {
  //   status = true;
  //   document.getElementById("pasnum").innerHTML = "";
